...
# Basic Configuration
#
APPNAME=BLE_EnvironmentSensingTemperature
TOOLCHAIN=GCC_ARM
CONFIG=Debug
VERBOSE=
...
ifeq ($(OTA_FW_UPGRADE),1)
# CY_CORE_OTA_FW_UPGRADE_STORE can be either on_chip_flash or external_sflash
# for CYW920819EVB-02 and CYW920820EVB-02 platforms as both the evaluation kits
# support external serial flash.
export CY_CORE_OTA_FW_UPGRADE_STORE=on_chip_flash
# fw_upgrade_lib component needs to be included for OTA feature
